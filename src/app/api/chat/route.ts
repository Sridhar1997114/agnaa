  ...
  try {
    ...
    if (userCount > 10) {
      return NextResponse.json({
        reply:
          'I have provided an extensive overview of your architectural vision. For a deep-dive technical consultation or to begin formal drafting, please contact Architect Sridhar directly: +91-8179261230 | hello@agnaa.in\n\n– Agnaa Design Studio | Transform visions into structures™',
      });
    }
