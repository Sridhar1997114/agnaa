...
export const calculators: CalculatorMeta[] = [
  // Phase 1 (Core)
  { id: 'brick', name: 'Brickwork Estimator', path: '/calc/brick', category: 'Structure', icon: Grid, description: 'Bricks, Cement, Sand count' },
  { id: 'rcc', name: 'RCC Slab / Rebar', path: '/calc/rcc', category: 'Structure', icon: Activity, description: 'Concrete & Steel estimation' },
  { id: 'fsi', name: 'FSI / FAR Calculator', path: '/calc/fsi', category: 'Financial', icon: Percent, description: 'Buildable area ratios' },
  
  // Phase 2 (Advanced Structure)
  { id: 'gn-floor', name: 'G+N Floor Estimator', path: '/calc/gn-floor', category: 'Structure', icon: Layers, description: 'Multi-floor buildable area' },
  ...
  { id: 'steel', name: 'Rebar / Steel Weight', path: '/calc/steel', category: 'Structure', icon: Weight, description: 'Thumb rule rebar weight' },
  { id: 'staircase', name: 'Staircase Designer', path: '/calc/staircase', category: 'Structure', icon: TrendingUp, description: 'Risers, Treads & Slopes' },
  ...
  { id: 'electrical', name: 'Electrical Load', path: '/calc/electrical', category: 'MEP', icon: Zap, description: 'Points & Load calculation' },
